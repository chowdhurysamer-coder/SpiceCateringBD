  ...
  if (failed) {
    return (
      <svg width={size} height={size} viewBox="0 0 120 120" fill="none" aria-label={alt} className={className}>
        ...
        <path d="M48 28 Q46 23 48 18 Q50 13 48 8" stroke="#C0581A" stroke-width="2.2" stroke-linecap="round" fill="none"/>
        <path d="M60 26 Q58 21 60 16 Q62 11 60 6" stroke="#C0581A" stroke-width="2.2" stroke-linecap="round" fill="none"/>
        <path d="M72 28 Q70 23 72 18 Q74 13 72 8" stroke="#C0581A" stroke-width="2.2" stroke-linecap="round" fill="none"/>
